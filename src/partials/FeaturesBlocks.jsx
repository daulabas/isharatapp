        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Always online</h4>
              <p className="text-gray-600 text-center">Now you don't need use dictionaries or desktop apps</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Share your translations</h4>
              <p className="text-gray-600 text-center">Gives opportunity to share the traslations</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">High qulaity of accuracy</h4>
              <p className="text-gray-600 text-center">Based on difficult machine learning system gives opportunity to detect signs with 78%</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">No limits</h4>
              <p className="text-gray-600 text-center">High speed of detection based on detection algos</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Simple and responsive design</h4>
              <p className="text-gray-600 text-center">Design basics was based on to be simple to use for deaf people</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Last technologies</h4>
              <p className="text-gray-600 text-center">Project was based on OpenCV and TensorflowJS, which year by year developing</p>
            </div>
